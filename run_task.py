...
def main(args):
    prompt_lf = {
        ...
        "hr_iterative": list_function_prompt.hr_iterative
    }
    prompt_ar = {
        ...
        "hr_iterative": arithmetic_prompt.hr_iterative
    }
    prompt_cr = {
        ...
        "hr_iterative": crypto_prompt.hr_iterative
    }
    ...
    print(f"Task: {args.task}, Task type: {args.task_type}, Model: {args.model}, Mode: {args.mode}")
