...
hr_iterative = """You have generated a rule that maps the following inputs to their corresponding outputs using a Python function. The input is a list of integers. The output is also a list of integers. Note that some examples may be noisy, and you should take this into account when proposing the rule. 
