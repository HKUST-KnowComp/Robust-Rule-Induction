base_prompt = """Please generate a rule that maps the following inputs to their corresponding outputs using a Python function. The input is an addition expression. The output is a string that represents the result of the expression.

{examples}

Hint: The numbers in all inputs and outputs are in the same base.
...
base_prompt_with_noise = """Please generate a rule that maps the following inputs to their corresponding outputs using a Python function. The input is an addition expression. The output is a string that represents the result of the expression. Note that some examples may be wrong, and you should take this into account when proposing the rule.
...
cot_prompt_with_noise = """Please generate a rule that maps the following inputs to their corresponding outputs using a Python function. The input is an addition expression. The output is a string that represents the result of the expression. Note that some examples may be wrong, and you should take this into account when proposing the rule.
...
iterative_prompt_with_noise = """You have generated a rule that maps the following inputs to their corresponding outputs using a Python function. The input is an addition expression. The output is a string that represents the result of the expression. Note that some examples may be noisy, and you should take this into account when proposing the rule. In the last step, your rule is
...
self_refine_base = """Please generate a rule that maps the following inputs to their corresponding outputs using a Python function. The input is an addition expression. The output is a string that represents the result of the expression. Note that some examples may be wrong, and you should take this into account when proposing the rule.
...
self_refine_feedback = """You have generated a rule that maps the following inputs to their corresponding outputs using a Python function. The input is an addition expression. The output is a string that represents the result of the expression.
...
hr_iterative = """You have generated a rule that maps the following inputs to their corresponding outputs using a Python function. The input is an addition expression. The output is a string that represents the result of the expression. Note that some examples may be noisy, and you should take this into account when proposing the rule. 
